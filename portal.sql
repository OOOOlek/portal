...
--
-- Host: 127.0.0.1
-- Czas generowania: 21 Lut 2024, 16:39
...
CREATE TABLE `friend` (
  `ID` int(11) NOT NULL,
  `profile1ID int` int(11) NOT NULL,
...
--
-- Struktura tabeli dla tabeli `profile type`
--

CREATE TABLE `profile type` (
  `ID` int(11) NOT NULL,
  `profileID` int(11) NOT NULL,
...
--
-- Indeksy dla tabeli `profile type`
--
ALTER TABLE `profile type`
  ADD PRIMARY KEY (`ID`);
...
--
-- AUTO_INCREMENT dla tabeli `profile type`
--
ALTER TABLE `profile type`
  MODIFY `ID` int(11) NOT NULL AUTO_INCREMENT;
